...
from inicio.views import saludo, saludo_template, saludo_con_cargador, saludo_con_render, condicion_y_bucle, inicio, crear_auto, listado_autos, ver_auto, eliminar_auto, actualizar_auto
